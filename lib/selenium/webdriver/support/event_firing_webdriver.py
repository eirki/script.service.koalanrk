...
from lib.selenium.webdriver.remote.webdriver import WebDriver
from lib.selenium.webdriver.remote.webelement import WebElement
...
class EventFiringWebDriver(object):
    ...
    def __init__(self, driver, event_listener):
        ...
        .. code-block:: python
            ...
            from lib.selenium.webdriver import Firefox
            from lib.selenium.webdriver.support.events import EventFiringWebDriver, AbstractEventListener
